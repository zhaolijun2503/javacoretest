...
public class RSAEncrypt {
	private static final String DEFAULT_PUBLIC_KEY= 
		...
		private static final String DEFAULT_PRIVATE_KEY=
				        "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAvAaU7SQcqr6U0B9s/pLa" + "\r" +
						"6ZinST2pos0tvxmNWkAPbpvlu3JCM/eyGqT5L2dSvpZxxWmllasKDlm+RsJdfZ68" + "\r" +
						"kyI9q94ctUfu1XI4O+1Sx6EeXzoFB7YbR1Rb9TtS3f56B1jfZDtSFkc2npzhzSKr" + "\r" +
						"b0jsc5l7UVpf6fAZnjdsgaumAOrOvGlnihyBeKSozmfdOC1aCTEgOt7dMF/K+gAn" + "\r" +
						"yDmP7YDTNxnnzBFMDso93Dh9B4HSsTdxAMuNzHE3QlniGiukRgLD/zhNNX0h21e8" + "\r" +
						"43gXs3Ce7h/B9YoJ15PFda2C4hTLfaUNFZsOfj0NdXvJmASjU+XNqx+td80pOebc" + "\r" +
						"ZwIDAQAB" + "\r";
		...
		public static void main(String[] args){
			...
			try {
				...
				//解密
				byte[] plainText = rsaEncrypt.decrypt(rsaEncrypt.getPrivateKey(), source.getBytes());
